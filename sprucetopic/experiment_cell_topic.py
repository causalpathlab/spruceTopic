...
if mode =='train':
	...
	loss_values = sp.run_cell_topic_model(batch_size,l_rate,epochs,layers,latent_dims,device)
	...
	latent_dims = args.cell_topic['train']['latent_dims']
	device = 'cpu'
	df_z,df_h,df_beta1 = sp.eval_cell_topic_model(batch_size,layers,latent_dims,device)

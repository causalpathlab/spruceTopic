...
h_sample_file = paste(ct_model_id,"_ct_3_h_kmeans_celltype_sample.csv.gz",sep="")
df_h = read.table(h_sample_file, sep = ",", header=TRUE)
struct_plot(df_h,paste(ct_model_id,'_ct_3_struct_plot_kmeans.pdf',sep=''))
########


source('fig_1_hmap.R')
topgenes_file = paste(ct_model_id,"_ct_4_beta_weight_top_25_genes.csv.gz",sep="")
...
f = paste(ct_model_id,"_ct_4_beta_hmap_tp_25.png",sep="")
top_genes=TRUE
weightmat_plot(df_beta,top_genes,df_tg,f)
...
source('fig_1_hmap.R')
topgenes_file = paste(ct_model_id,"_ct_4_beta_weight_top_25_genes_selected.csv.gz",sep="")
df_beta = read.table(topgenes_file, sep = ",", header=TRUE,row.names=1)

top3_file = paste(ct_model_id,"_ct_4_beta_weight_top_25_genes_top3.csv.gz",sep="")
...
f = paste(ct_model_id,"_ct_4_beta_hmap_tp_selected.pdf",sep="")
...
topgenes_file = paste(it_model_id,"_it_5_beta_weight_top_10_genes.csv.gz",sep="")
...
tag='ligands'
f = paste(it_model_id,"_it_5_beta_weight_top_10_ligands.pdf",sep="")
top_genes=TRUE
...
df_beta = df_beta[c("2","4","7", "10","18","22","24"),]
tag='receptors'
f = paste(it_model_id,"_it_5_beta_weight_top_10_receptors.pdf",sep="")
top_genes=TRUE
weightmat_lr_plot(df_beta,tag,top_genes,topgenes_file,f)
...
summary_file = paste(it_model_id,'_it_3_cell_nbr_ct_it_summary.csv.gz',sep="")
df_summary = read.table(summary_file,sep=',', header=TRUE)
f = paste(it_model_id,'_it_3_cell_nbr_ct_it_summary.pdf',sep="")
col=4
...
df = read.table(paste(it_model_id,'_it_4_cancercells_it_celltypedist.csv.gz',sep=""),sep=',', header=TRUE)
f = paste(it_model_id,"_it_4_cancercells_it_celltypedist.pdf",sep="")

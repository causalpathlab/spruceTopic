...
p.set_xlabel("UMAP1",fontsize=20)
p.set_ylabel("UMAP2",fontsize=20)
plt.savefig(spr.cell_topic.model_id+'_ct_umap_celltype_label.png');plt.close()
...
p.set_xlabel("UMAP1",fontsize=20)
p.set_ylabel("UMAP2",fontsize=20)
plt.savefig(spr.cell_topic.model_id+'_ct_h_kmeans.png');plt.close()
...
df_h_sample = _topics.sample_cells_with_celltype(spr)
df_h_sample.to_csv(spr.model_id+'_ct_h_sample_celltype.csv.gz',index=False,compression='gzip')

...
`r sprintf("![Interaction topic argmax](%s)", paste(params$it_model_id,'_it_h_argmax.png',sep=''))`
...
`r sprintf("![Model summary - cancer cells](%s)", paste(params$it_model_id,'_it_model_summary_cancer.png',sep=''))`

`r sprintf("![Model summary - normal cells](%s)", paste(params$it_model_id,'_it_model_summary_normal.png',sep=''))`

`r sprintf("![Model summary - others](%s)", paste(params$it_model_id,'_it_model_summary_others.png',sep=''))`

`r sprintf("![Network plot](%s)", paste(params$it_model_id,'_it_model_network_plot.png',sep=''))`

`r sprintf("![Cancer centric view](%s)", paste(params$it_model_id,'_it_ccview_stplot.png',sep=''))`

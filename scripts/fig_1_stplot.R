...
hh_file = paste(args_home,args$output,args$nbr_model$out,args$nbr_model$mfile,"_netm_h_topic_sample.tsv",sep="")
...
f = paste(args_home,args$output,args$nbr_model$out,args$nbr_model$mfile,"_netm_st_plot.pdf",sep="")

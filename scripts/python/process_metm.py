...
def topic_top_genes(args,top_n=5):
	...
	top_genes = []
	top_genes = generate_gene_vals(df_beta1,top_n,top_genes,'T cell')
	top_genes = generate_gene_vals(df_beta2,top_n,top_genes,'non T cell')
...
def sample_cells_with_latent(args,cell_n=100):

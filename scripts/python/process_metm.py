...
def get_top_genes(args,top_n=3):
    ...
    df_beta1 = pd.read_csv(args.home+args.output+args.nbr_model["out"]+args.nbr_model["mfile"]+"etm_beta1_data.csv",sep="\t")
    df_beta2 = pd.read_csv(args.home+args.output+args.nbr_model["out"]+args.nbr_model["mfile"]+"etm_beta2_data.csv",sep="\t")
